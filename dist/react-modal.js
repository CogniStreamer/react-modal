...
var Modal = function (_Component) {
  ...
  function Modal() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Modal.__proto__ || Object.getPrototypeOf(Modal)).call.apply(_ref, [this].concat(args))), _this), _this.node = document.createElement('div'), _this.removePortal = function () {
      var parent = getParentElement(_this.props.parentSelector);
      parent.removeChild(_this.node);
    }, _this.getPortalRef = function (portal) {
      _this.portal = portal;
  ...
  _createClass(Modal, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (!this.props.isOpen && !newProps.isOpen) return;
    ...
    value: function render() {
      ...
      return _reactDom2.default.createPortal(_react2.default.createElement(_ModalPortal2.default, _extends({
